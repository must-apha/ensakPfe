...
<body>
    ...
    <h3 class="container">Les étudiants qui n'ont pas déposé le rapport</h3>
    <table class="container table table-responsive-sm table-striped table-hover wow fadeInUp " data-wow-delay="0.5s">
    <?php
            include("connexion.php");
             $sql = "SELECT nom_etudiant1,prenom_etudiant1 FROM etudiants INNER JOIN stages
              ON stages.fk_id_etudiant=etudiants.id_apogee WHERE stages.rapport_ver1 IS NULL";
