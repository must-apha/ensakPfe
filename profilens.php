...
<?php
    ...
    $nom = $_SESSION['nom_enseignant'];
    $prenom = $_SESSION['prenom_enseignant'];
    $login = $_SESSION['login_enseignant'] ;
    $passe = $_SESSION['passe_enseignant'];
    $photo = $_SESSION['photo_enseignant'];
...
<div class="container bg-light mt-1 mb-5 wow fadeInUp" data-wow-delay="0.5s">
    <form action="traitementProfilens.php" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
               <?php $sql1 = "SELECT * FROM enseignants WHERE id_enseignant='$id_enseignant'";
                $res1 = mysqli_query($link,$sql1);
                while($data1= mysqli_fetch_assoc($res1)){
                    $ph = $data1['photo_enseignant'];
