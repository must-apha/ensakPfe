    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="administration.php" class="nav-item nav-link active">Espace administration</a>
            </div>
        ...
        <div class="container ">
            <div class="row g-6">
                ...
                <div class="col-lg-4 col-sm-6 wow mb-4 fadeInUp" data-wow-delay="0.5s">
                    <a href="etudParEns.php">
                    <div class="service-item text-center pt-3" style="height: 200px">
                        <div class="p-4">
                            <i class="fa fa-3x fa-home text-primary mb-4"></i>
                            <h5 class="mb-3">Les étudiants par enseignant</h5>
                        </div>
                    </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6 wow mb-4 fadeInUp" data-wow-delay="0.7s">
                        <a href="etudSansEnc.php">
                        <div class="service-item text-center pt-3" style="height: 200px"> 
                            <div class="p-4">
                                <i class="fa fa-3x fa-book-open text-primary mb-4"></i>
                                <h5 class="mb-3">Les étudiants sans encadrants</h5>
                            </div>
                        </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6 wow mb-4 fadeInUp" data-wow-delay="0.7s">
                        <a href="pasRapport.php">
                        <div class="service-item text-center pt-3" style="height: 200px">
                            <div class="p-4">
                                <i class="fa fa-3x fa-book-open text-primary mb-4"></i>
                                <h5 class="mb-3">Les étudiants qui n’ont pas déposer le rapport</h5>
                            </div>
                        </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6 wow mb-4 fadeInUp" data-wow-delay="0.7s">
                        ...
                        <div class="service-item text-center pt-3" style="height: 200px">
                            <div class="p-4">
                                <i class="fa fa-3x fa-book-open text-primary mb-4"></i>
                                <h5 class="mb-3">Les stages validés</h5>
                            </div>
                        </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6 mx-auto wow mb-4 fadeInUp" data-wow-delay="0.7s">
                        <a href="notes.php">
                        <div class="service-item text-center pt-3" style="height: 200px">
                            <div class="p-4">
                                <i class="fa fa-3x fa-book-open text-primary mb-4"></i>
                                <h5 class="mb-3">Les notes</h5>
                            </div>
                        </div>
                        </a>
                    </div>
